<template>
    <div id="userattention">
        ...
        <div v-if="isShow" style="text-align: center">
            ...
            <p style="font-weight: bolder">暂时没关注喔~</p>
        </div>
...
<script>
  ...
  import {getUserAttention} from "../../../service/api";
  ...
  export default {
    ...
    methods: {
      async getAttentionList() {
        let res = await getUserAttention(this.userInfo.uId, this.pageNum, this.currentPage)
