    ...
    <div id="useraction">
        ...
        <template>
            <el-tabs v-model="activeName"
                     ...
                     type="border-card">
                <el-tab-pane label="价值用户" name="first" :key="'first'">
                    <div class="userdata" v-if="isFirst">
                        <popularUser></popularUser>
                    </div>
                </el-tab-pane>
                <el-tab-pane label="喜爱本平台的用户" name="second" :key="'second'">
                    <div class="likepartuser" v-if="isSecond">
                        <likePartUser></likePartUser>
                    </div>

                </el-tab-pane>
                <el-tab-pane label="人气用户" name="third" :key="'third'">
                    <div class="valueuser" v-if="isThird">
                        <valueUser></valueUser>
                    </div>
                </el-tab-pane>
                <el-tab-pane label="可激励用户" name="forth" :key="'forth'">
